...
InitChatCommands()
{
    ...
    level.chat_commands["ports"] = ["28960", "28961"]; // an array of the ports of all your servers you want to have the script running on. This is useful to easily pass this array as first arg of CreateCommand to have the command on all your servers
...
{
    return ["The command " + commandName + " doesn't have any alias"];
}
